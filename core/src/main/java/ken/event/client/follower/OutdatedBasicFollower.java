 ...
 * 
 */
public class OutdatedBasicFollower extends Thread implements IFollower {

	public static Logger LOG = Logger.getLogger(OutdatedBasicFollower.class);
	...
	protected OutdatedBasicFollower(String key) {
		super();
